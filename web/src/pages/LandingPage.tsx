      ...
      <div className="flex items-center justify-between gap-4">
        <div>
          ...
          <p className="mt-2 text-[13px] leading-relaxed text-gray-400">
            Paste a public GitHub repository URL. dpylens will clone + analyze it and generate a report you can open in a
            separate tab.
          </p>
        </div>
        {badge("Local dev")}
      ...
      <div className="relative mx-auto max-w-7xl px-6 pb-20 pt-12">
        <header className="text-center">
          ...
          <p className="mx-auto mt-3 max-w-3xl text-sm leading-relaxed text-gray-400">
            Import a repo, run static analysis, generate a deterministic summary, and open the report in a new tab.
          </p>

          <div className="mt-6 flex flex-wrap items-center justify-center gap-3">
            {badge("Dark Intelligence UI")}
            {badge("Static Analysis")}
            {badge("Report Explorer")}
          </div>
        </header>
            ...
            {result ? (
              <div className="p-6">
                ...
                <div className="mt-5 flex flex-wrap items-center gap-3">
                  <a
                    className="inline-flex items-center gap-2 rounded-xl border border-cyan-500/30 bg-cyan-500/15 px-4 py-3 text-sm font-semibold text-cyan-100 hover:bg-cyan-500/20"
                    href={reportUrlAbsolute(result.report_url)}
                    target="_blank"
                    rel="noreferrer"
                  >
                  ...
                  <span className="text-[12px] text-gray-500">
                    Opens: <code className="text-gray-300">{reportUrlAbsolute(result.report_url)}</code>
                  </span>
                </div>
              </div>
            ) : (
